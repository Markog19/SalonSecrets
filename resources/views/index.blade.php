          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li> <a  class="section-btn" href="{{ URL::route('login') }}">Prijava</a>
                                           </li>
                    <li>
                         <a href="{{ URL::route('register') }}" class="section-btn">Registracija</a>
                         </li>
                              ...
                              <div class="caption">
                                   <div class="container">
                                        <div class="col-md-8 col-sm-12">
                                             ...
                                             <a href="#team" class="section-btn btn btn-default smoothScroll">Upoznajte naše osoblje</a>
                                        </div>
                                   </div>
                              </div>
                         </div>
